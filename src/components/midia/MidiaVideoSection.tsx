...
import { Volume2, VolumeX, FileSearch, ArrowRight } from "lucide-react";

const MidiaVideoSection = () => {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            Depois, faça seu <strong className="text-foreground">Diagnóstico Preliminar Gratuito</strong> e descubra o risco que sua empresa está correndo.
          </p>
        </motion.div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3 text-primary-foreground">
                ...
                <span className="text-sm md:text-base font-medium">
                  Descubra o risco da sua empresa agora
                </span>
              </div>
              <a
...
export default MidiaVideoSection;
