...
import { CheckCircle2, ArrowRight, Shield, Clock, AlertTriangle, FileSearch } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 leading-tight">
                Faça seu
                <span className="text-primary"> Diagnóstico Preliminar Gratuito</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-4 leading-relaxed">
                Descubra agora o nível de risco da sua empresa com nosso
                <strong className="text-foreground"> Diagnóstico Preliminar Gratuito</strong>. Ele aponta se sua empresa está em risco
                Alto, Médio ou Baixo em relação à nova NR-1.
              </p>
            ...
            >
              ...
              <div className="mt-6 p-4 bg-primary/5 rounded-lg border border-primary/20">
                <p className="text-sm text-foreground/80 text-center">
                  <strong>É simples:</strong> Faça o Diagnóstico Preliminar Gratuito → Descubra o nível de risco → Proteja sua empresa antes do prazo.
                </p>
              </div>
            </motion.div>
          </div>
...
export default MidiaDiagnosticSection;
